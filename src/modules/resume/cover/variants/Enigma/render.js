...
const Enigma = (
  ...
  const main = {backgroundColor: theme.value.color,
    ...
    display:"block"}
  const locationIcon = 'https://github.com/fouzanmohd/webproject1/blob/master/place.png?raw=true'
  const emailIcon = 'https://github.com/fouzanmohd/webproject1/blob/master/email.png?raw=true'
  const phoneIcon = 'https://github.com/fouzanmohd/webproject1/blob/master/telephone.png?raw=true'
      ...
      <div style = {styles.container}>       
        ...
        <div style={styles.secondBox}>
          ...
          <div style={styles.socialBox}>            
              {linkedIn.value && <p style={styles.socialValue}>{linkedIn.value}</p>}
